...
interface AlertProps {
  ...
  export function Alert({ children, variant = 'info', dismissible = false, onDismiss }: AlertProps) {
    ...
    switch (variant) {
      case 'info':
        variantClasses = 'bg-blue-50 text-blue-700 border-blue-500';
        icon = (
        ...
        break;
      case 'success':
        variantClasses = 'bg-green-50 text-green-700 border-green-500';
        icon = (
        ...
        break;
      case 'warning':
        variantClasses = 'bg-yellow-50 text-yellow-700 border-yellow-500';
        icon = (
        ...
        break;
      case 'error':
        variantClasses = 'bg-red-50 text-red-700 border-red-500';
        icon = (
    ...
    return (
      <div className={`rounded-md p-4 border-l-4 ${variantClasses}`}>
        <div className="flex">
